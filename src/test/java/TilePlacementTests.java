...
public class TilePlacementTests {
    ...
    public void isTileDestinationValidTest_OriginEmpty(){
        ...
        Assert.assertEquals("test",true,GameAPIUtil.isTileDestinationValid(testTile, originCoords, game.gameBoard));
    }
    ...
    public void isTileDestinationValidTest_VolcanoConnected(){
        ...
        Assert.assertEquals("test",true,GameAPIUtil.isTileDestinationValid(testTile, testCoords, game.gameBoard));
    ...
    public void isTileDestinationValidTest_NoHexConnected(){
        ...
        Assert.assertEquals("test",false,GameAPIUtil.isTileDestinationValid(testTile, testCoords, game.gameBoard));

...
public class clientMessageTests {
    ...
    public void foundMessageTest()
    {
        ...
        String actualMessage = ("GAME 1 MOVE 1 PLACE JUNGLE+GRASS AT 0 0 0 1 FOUND SETTLEMENT AT 0 0 0");
    ...
    public void expandMessageTest()
    {
        ...
        String actualMessage = ("GAME 1 MOVE 1 PLACE JUNGLE+GRASS AT 0 0 0 1 EXPAND SETTLEMENT AT 0 0 0 ROCK");
        Assert.assertEquals(actualMessage, testMessage);
    ...
    public void totoroMessageTest()
    {
        ...
        String actualMessage = ("GAME 1 MOVE 1 PLACE JUNGLE+GRASS AT 0 0 0 1 BUILD TOTORO SANCTUARY AT 0 0 0");
        Assert.assertEquals(actualMessage, testMessage);
    ...
    public void tigerMessageTest()
    {
        ...
        String actualMessage = ("GAME 1 MOVE 1 PLACE JUNGLE+GRASS AT 0 0 0 1 BUILD TIGER PLAYGROUND AT 0 0 0");
        Assert.assertEquals(actualMessage, testMessage);
    ...
    public void unableMessageTest()
    {
        ...
        String actualMessage = ("GAME 1 MOVE 1 PLACE JUNGLE+GRASS AT 0 0 0 1 UNABLE TO BUILD");
        Assert.assertEquals(actualMessage, testMessage);
